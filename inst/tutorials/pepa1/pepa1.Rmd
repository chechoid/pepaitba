---
title: "Pensamiento Estadístico en People Analytics"
...
# Realizar un gráfico de la variable sueldo_bruto
...
puestos <- kiwi_ar %>% 
  select(puesto) %>%    # Seleccionamos la columna 'puesto'
